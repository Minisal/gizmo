...
public class LeftPanel extends AbstractGizmo{
    public LeftPanel(AnimationWindow animationWindow) {
    ...
    public LeftPanel(int x, int y, int r, int degree, AnimationWindow animationWindow) {
