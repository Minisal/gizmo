 ...
 *
 * @specfield    name              : String   // a unique name for a counter
 * @specfield    totalTime         : long     // total time of all measurements taken
 * @specfield    totalInvocations  : int      // total number of measurements taken
 * @derivedfield averageTime       : double   // average time of all measurements (totalTime / totalInvocations)
...
public final class Counter
{
    ...
    /**
     * @effects starts a measurement using this counter
     */
    ...
    /**
     * @effects stops a measurement using this counter
    ...
    /**
     * @effects returns this counter to its original state
